...
var ta = { MUST_USE_PROPERTY: 1, HAS_BOOLEAN_VALUE: 4, HAS_NUMERIC_VALUE: 8, HAS_POSITIVE_NUMERIC_VALUE: 24, HAS_OVERLOADED_BOOLEAN_VALUE: 32, HAS_STRING_BOOLEAN_VALUE: 64, injectDOMPropertyConfig: function (a) {
    var b = ta,
      ...
      ua.hasOwnProperty(f) ? E$1("48", f) : void 0;var g = f.toLowerCase(),
...
var P$1 = { _caughtError: null, _hasCaughtError: !1, _rethrowError: null, _hasRethrowError: !1, injection: { injectErrorUtils: function (a) {
      "function" !== typeof a.invokeGuardedCallback ? E$1("197") : void 0;Ja = a.invokeGuardedCallback;
    ...
    P$1.invokeGuardedCallback.apply(this, arguments);if (P$1.hasCaughtError()) {
      var q = P$1.clearCaughtError();P$1._hasRethrowError || (P$1._hasRethrowError = !0, P$1._rethrowError = q);
    }
    ...
    if (P$1._hasCaughtError) {
      var a = P$1._caughtError;P$1._caughtError = null;P$1._hasCaughtError = !1;return a;
    }E$1("198");
  } };function Ja(a, b, c, d, e, f, g, h, k) {
  P$1._hasCaughtError = !1;P$1._caughtError = null;var q = Array.prototype.slice.call(arguments, 3);try {
    b.apply(c, q);
  } catch (v) {
...
function Ka() {
  if (P$1._hasRethrowError) {
    var a = P$1._rethrowError;P$1._rethrowError = null;P$1._hasRethrowError = !1;throw a;
  }
}var La = null,
    Ma = {};
function Na() {
  if (La) for (var a in Ma) {
    var b = Ma[a],
        c = La.indexOf(a);-1 < c ? void 0 : E$1("96", a);if (!Oa[c]) {
      b.extractEvents ? void 0 : E$1("97", a);Oa[c] = b;c = b.eventTypes;for (var d in c) {
        var e = void 0;var f = c[d],
            g = b,
            h = d;Pa.hasOwnProperty(h) ? E$1("99", h) : void 0;Pa[h] = f;var k = f.phasedRegistrationNames;if (k) {
          for (e in k) k.hasOwnProperty(e) && Qa(k[e], g, h);e = !0;
        } else f.registrationName ? (Qa(f.registrationName, g, h), e = !0) : e = !1;e ? void 0 : E$1("98", d, a);
      }
    }
  }
}
function Qa(a, b, c) {
  Ra[a] ? E$1("100", a) : void 0;Ra[a] = b;Sa[a] = b.eventTypes[c].dependencies;
}var Oa = [],
    Pa = {},
    Ra = {},
    Sa = {};function Ta(a) {
  La ? E$1("101") : void 0;La = Array.prototype.slice.call(a);Na();
}function Ua(a) {
  var b = !1,
      c;for (c in a) if (a.hasOwnProperty(c)) {
    var d = a[c];Ma.hasOwnProperty(c) && Ma[c] === d || (Ma[c] ? E$1("102", c) : void 0, Ma[c] = d, b = !0);
  }b && Na();
}
...
function $a(a, b) {
  null == b ? E$1("30") : void 0;if (null == a) return b;if (Array.isArray(a)) {
...
function ib(a, b) {
  var c = a.stateNode;if (!c) return null;var d = Wa(c);if (!d) return null;c = d[b];a: switch (b) {case "onClick":case "onClickCapture":case "onDoubleClick":case "onDoubleClickCapture":case "onMouseDown":case "onMouseDownCapture":case "onMouseMove":case "onMouseMoveCapture":case "onMouseUp":case "onMouseUpCapture":
      ...
      a = !1;}if (a) return null;c && "function" !== typeof c ? E$1("231", b, typeof c) : void 0;
  return c;
}function jb(a, b, c, d) {
  ...
  var b = bb;bb = null;b && (a ? ab(b, db) : ab(b, gb), bb ? E$1("95") : void 0, P$1.rethrowCaughtError());
    ...
    Q$1 = "__reactInternalInstance$" + nb,
    ob = "__reactEventHandlers$" + nb;
function pb(a) {
  if (a[Q$1]) return a[Q$1];for (var b = []; !a[Q$1];) if (b.push(a), a.parentNode) a = a.parentNode;else return null;var c = void 0,
      d = a[Q$1];if (5 === d.tag || 6 === d.tag) return d;for (; a && (d = a[Q$1]); a = b.pop()) c = d;return c;
}function qb(a) {
  if (5 === a.tag || 6 === a.tag) return a.stateNode;E$1("33");
}function rb(a) {
  return a[ob] || null;
}
var sb = Object.freeze({ precacheFiberNode: function (a, b) {
    ...
    a = a[Q$1];return !a || 5 !== a.tag && 6 !== a.tag ? null : a;
...
}var S$1 = { _root: null, _startText: null, _fallbackText: null };
function Fb() {
  if (S$1._fallbackText) return S$1._fallbackText;var a,
      b = S$1._startText,
      c = b.length,
      d,
      e = Gb(),
      f = e.length;for (a = 0; a < c && b[a] === e[a]; a++);var g = c - a;for (d = 1; d <= g && b[c - d] === e[f - d]; d++);S$1._fallbackText = e.slice(a, 1 < d ? 1 - d : void 0);return S$1._fallbackText;
}function Gb() {
...
var Hb = "dispatchConfig _targetInst nativeEvent isDefaultPrevented isPropagationStopped _dispatchListeners _dispatchInstances".split(" "),
    Ib = { type: null, target: null, currentTarget: emptyFunction_1.thatReturnsNull, eventPhase: null, bubbles: null, cancelable: null, timeStamp: function (a) {
...
objectAssign(T$1.prototype, { preventDefault: function () {
  ...
  } });T$1.Interface = Ib;T$1.augmentClass = function (a, b) {
...
};Jb(T$1);function Kb(a, b, c, d) {
  if (this.eventPool.length) {
    var e = this.eventPool.pop();this.call(e, a, b, c, d);return e;
  }return new this(a, b, c, d);
}
function Lb(a) {
  a instanceof this ? void 0 : E$1("223");a.destructor();10 > this.eventPool.length && this.eventPool.push(a);
}function Jb(a) {
  ...
  return T$1.call(this, a, b, c, d);
}T$1.augmentClass(Nb, { data: null });var Pb = [9, 13, 27, 32],
    Vb = ExecutionEnvironment_1.canUseDOM && "CompositionEvent" in window,
    Wb = null;ExecutionEnvironment_1.canUseDOM && "documentMode" in document && (Wb = document.documentMode);var Xb;
...
var Zb = Xb,
    $b = ExecutionEnvironment_1.canUseDOM && (!Vb || Wb && 8 < Wb && 11 >= Wb),
...
function hc(a, b) {
  if (fc) return "topCompositionEnd" === a || !Vb && dc(a, b) ? (a = Fb(), S$1._root = null, S$1._startText = null, S$1._fallbackText = null, fc = !1, a) : null;switch (a) {case "topPaste":
...
var ic = { eventTypes: bc, extractEvents: function (a, b, c, d) {
    ...
    } else fc ? dc(a, c) && (f = bc.compositionEnd) : "topKeyDown" === a && 229 === c.keyCode && (f = bc.compositionStart);f ? ($b && (fc || f !== bc.compositionStart ? f === bc.compositionEnd && fc && (e = Fb()) : (S$1._root = d, S$1._startText = Gb(), fc = !0)), f = Mb.getPooled(f, b, c, d), e ? f.data = e : (e = ec(c), null !== e && (f.data = e)), Ab(f), e = f) : e = null;(a = Zb ? gc(a, c) : hc(a, c)) ? (b = Nb.getPooled(bc.beforeInput, b, c, d), b.data = a, Ab(b)) : b = null;return [e, b];
  } },
    jc = null,
    kc = null,
    lc = null;function mc(a) {
  if (a = Xa(a)) {
    jc && "function" === typeof jc.restoreControlledState ? void 0 : E$1("194");var b = Wa(a.stateNode);jc.restoreControlledState(a.stateNode, a.type, b);
  }
...
function Ec(a, b, c) {
  a = T$1.getPooled(Dc.change, a, b, c);a.type = "change";oc(c);Ab(a);return a;
}var Fc = null,
...
}var Kc = !1;ExecutionEnvironment_1.canUseDOM && (Kc = yc("input") && (!document.documentMode || 9 < document.documentMode));function Lc() {
...
var ad = { eventTypes: Dc, _isInputEventSupported: Kc, extractEvents: function (a, b, c, d) {
  ...
  return T$1.call(this, a, b, c, d);
}T$1.augmentClass(bd, { view: null, detail: null });var cd = { Alt: "altKey", Control: "ctrlKey", Meta: "metaKey", Shift: "shiftKey" };function dd(a) {
...
var gd = { mouseEnter: { registrationName: "onMouseEnter", dependencies: ["topMouseOut", "topMouseOver"] }, mouseLeave: { registrationName: "onMouseLeave", dependencies: ["topMouseOut", "topMouseOver"] } },
    ...
    id = react.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner;function jd(a) {
...
function nd(a) {
  var b = a.alternate;if (!b) return b = kd(a), 3 === b ? E$1("188") : void 0, 1 === b ? null : a;for (var c = a, d = b;;) {
    var e = c["return"],
  ...
  }3 !== c.tag ? E$1("188") : void 0;return c.stateNode.current === c ? a : b;
}function od(a) {
...
var xd = Object.freeze({ get _enabled() {
    ...
    return td;
  }, trapBubbledEvent: U$1, trapCapturedEvent: wd, dispatchEvent: vd });function yd(a, b) {
  var c = {};c[a.toLowerCase()] = b.toLowerCase();c["Webkit" + a] = "webkit" + b;c["Moz" + a] = "moz" + b;c["ms" + a] = "MS" + b;c["O" + a] = "o" + b.toLowerCase();return c;
}
var zd = { animationend: yd("Animation", "AnimationEnd"), animationiteration: yd("Animation", "AnimationIteration"), animationstart: yd("Animation", "AnimationStart"), transitionend: yd("Transition", "TransitionEnd") },
    Ad = {},
    Bd = {};ExecutionEnvironment_1.canUseDOM && (Bd = document.createElement("div").style, "AnimationEvent" in window || (delete zd.animationend.animation, delete zd.animationiteration.animation, delete zd.animationstart.animation), "TransitionEvent" in window || delete zd.transitionend.transition);
function Cd(a) {
...
var Sd = { eventTypes: Md, extractEvents: function (a, b, c, d) {
  ...
  return T$1.call(this, a, b, c, d);
}T$1.augmentClass(Ud, { clipboardData: function (a) {
...
bd.augmentClass(Zd, { key: function (a) {
  ...
  return T$1.call(this, a, b, c, d);
}T$1.augmentClass(be, { propertyName: null, elapsedTime: null, pseudoElement: null });
function ce(a, b, c, d) {
  return T$1.call(this, a, b, c, d);
...
var fe = { eventTypes: de, extractEvents: function (a, b, c, d) {
    var e = ee[a];if (!e) return null;switch (a) {case "topKeyPress":
        ...
        a = Ud;break;default:
        a = T$1;}b = a.getPooled(e, b, c, d);Ab(b);return b;
  } };sd = function (a, b, c, d) {
...
}var ie = { current: emptyObject_1 },
    X = { current: !1 },
    je = emptyObject_1;function ke(a) {
...
function oe(a, b, c) {
  null != ie.cursor ? E$1("168") : void 0;W$1(ie, b, a);W$1(X, c, a);
}function pe(a, b) {
  var c = a.stateNode,
      d = a.type.childContextTypes;if ("function" !== typeof c.getChildContext) return b;c = c.getChildContext();for (var e in c) e in d ? void 0 : E$1("108", jd(a) || "Unknown", e);return objectAssign({}, b, c);
}function qe(a) {
  if (!le(a)) return !1;var b = a.stateNode;b = b && b.__reactInternalMemoizedMergedChildContext || emptyObject_1;je = ie.current;W$1(ie, b, a);W$1(X, X.current, a);return !0;
}
function re(a, b) {
  var c = a.stateNode;c ? void 0 : E$1("169");if (b) {
    var d = pe(a, je);c.__reactInternalMemoizedMergedChildContext = d;V$1(X, a);V$1(ie, a);W$1(ie, d, a);
  } else V$1(X, a);W$1(X, b, a);
}
function Y(a, b, c) {
...
function te(a, b, c) {
  var d = void 0,
      e = a.type,
      f = a.key;"function" === typeof e ? (d = e.prototype && e.prototype.isReactComponent ? new Y(2, f, b) : new Y(0, f, b), d.type = e, d.pendingProps = a.props) : "string" === typeof e ? (d = new Y(5, f, b), d.type = e, d.pendingProps = a.props) : "object" === typeof e && null !== e && "number" === typeof e.tag ? (d = e, d.pendingProps = a.props) : E$1("130", null == e ? e : typeof e, "");d.expirationTime = c;return d;
}function ue(a, b, c, d) {
...
function Je(a, b, c, d, e, f) {
  null !== a && a.updateQueue === c && (c = b.updateQueue = { baseState: c.baseState, expirationTime: c.expirationTime, first: c.first, last: c.last, isInitialized: c.isInitialized, callbackList: null, hasForceUpdate: !1 });c.expirationTime = 0;c.isInitialized ? a = c.baseState : (a = c.baseState = b.memoizedState, c.isInitialized = !0);for (var g = !0, h = c.first, k = !1; null !== h;) {
    var q = h.expirationTime;if (q > f) {
      ...
      k || (c.first = h.next, null === c.first && (c.last = null));if (h.isReplace) a = Ie(h, d, a, e), g = !0;else if (q = Ie(h, d, a, e)) a = g ? objectAssign({}, a, q) : objectAssign(a, q), g = !1;h.isForced && (c.hasForceUpdate = !0);null !== h.callback && (q = c.callbackList, null === q && (q = c.callbackList = []), q.push(h));
    }h = h.next;
...
function Ke(a, b) {
  var c = a.callbackList;if (null !== c) for (a.callbackList = null, a = 0; a < c.length; a++) {
    var d = c[a],
        e = d.callback;d.callback = null;"function" !== typeof e ? E$1("191", e) : void 0;e.call(b);
  }
}
function Le(a, b, c, d) {
  function e(a, b) {
    b.updater = f;a.stateNode = b;b._reactInternalFiber = a;
      ...
      var c = a.type,
          ...
          g = f ? me(a, d) : emptyObject_1;b = new c(b, g);e(a, b);f && (a = a.stateNode, a.__reactInternalMemoizedUnmaskedChildContext = d, a.__reactInternalMemoizedMaskedChildContext = g);return b;
      ...
      var g = b.stateNode;g.props = b.memoizedProps;g.state = b.memoizedState;var h = b.memoizedProps,
          k = b.pendingProps;k || (k = h, null == k ? E$1("159") : void 0);var u = g.context,
        ...
        var I = b.stateNode,
            L = b.type;G = "function" === typeof I.shouldComponentUpdate ? I.shouldComponentUpdate(G, e, z) : L.prototype && L.prototype.isPureReactComponent ? !shallowEqual_1(h, G) || !shallowEqual_1(u, e) : !0;
...
function Ze(a, b) {
  var c = b.ref;if (null !== c && "function" !== typeof c) {
    if (b._owner) {
      b = b._owner;var d = void 0;b && (2 !== b.tag ? E$1("110") : void 0, d = b.stateNode);d ? void 0 : E$1("147", c);var e = "" + c;if (null !== a && null !== a.ref && a.ref._stringRef === e) return a.ref;a = function (a) {
        var b = d.refs === emptyObject_1 ? d.refs = {} : d.refs;null === a ? delete b[e] : b[e] = a;
      };a._stringRef = e;return a;
    }"string" !== typeof c ? E$1("148") : void 0;b._owner ? void 0 : E$1("149", c);
  }return c;
}
function $e(a, b) {
...
function af(a) {
  function b(b, c) {
    ...
    var h = Xe(m);"function" !== typeof h ? E$1("150") : void 0;m = h.call(m);null == m ? E$1("151") : void 0;for (var r = h = null, n = g, w = g = 0, k = null, x = m.next(); null !== n && !x.done; w++, x = m.next()) {
    ...
    var m = "object" === typeof f && null !== f;if (m) switch (f.$$typeof) {case Re:
        ...
        h = a.type, E$1("152", h.displayName || h.name || "Component");}return c(a, d);
  };
}var bf = af(!0),
    cf = af(!1);
function df(a, b, c, d, e) {
  function f(a, b, c) {
    ...
    null !== a && b.child !== a.child ? E$1("153") : void 0;if (null !== b.child) {
    ...
    a.memoizedState = b;
      ...
      if (0 === b.expirationTime || b.expirationTime > c) return v(a, b);switch (b.tag) {case 0:
          null !== a ? E$1("155") : void 0;var d = b.type,
              e = b.pendingProps,
          ...
          return e = qe(b), d = void 0, null === a ? b.stateNode ? E$1("153") : (m(b, b.pendingProps), A(b, c), d = !0) : d = Ob(a, b, c), h(a, b, d, e);case 3:
          ...
          G(b);null === a && J(b);e = b.type;var n = b.memoizedProps;d = b.pendingProps;null === d && (d = n, null === d ? E$1("154") : void 0);r = null !== a ? a.memoizedProps : null;X.current || null !== d && n !== d ? (n = d.children, y(e, d) ? n = null : r && y(e, r) && (b.effectTag |= 16), g(a, b), 2147483647 !== c && !u && z(e, d) ? (b.expirationTime = 2147483647, b = null) : (f(a, b, n), b.memoizedProps = d, b = b.child)) : b = q(a, b);return b;case 6:
          return null === a && J(b), a = b.pendingProps, null === a && (a = b.memoizedProps), b.memoizedProps = a, null;case 8:
          b.tag = 7;case 7:
          e = b.pendingProps;if (X.current) null === e && (e = a && a.memoizedProps, null === e ? E$1("154") : void 0);else if (null === e || b.memoizedProps === e) e = b.memoizedProps;d = e.children;b.stateNode = null === a ? cf(b, b.stateNode, d, c) : bf(b, b.stateNode, d, c);b.memoizedProps = e;return b.stateNode;
        case 9:
          return null;case 4:
          a: {
            I(b, b.stateNode.containerInfo);e = b.pendingProps;if (X.current) null === e && (e = a && a.memoizedProps, null == e ? E$1("154") : void 0);else if (null === e || b.memoizedProps === e) {
              b = q(a, b);break a;
...
function ef(a, b, c) {
  ...
  return { completeWork: function (a, b, c) {
      var m = b.pendingProps;if (null === m) m = b.memoizedProps;else if (2147483647 !== b.expirationTime || 2147483647 === c) b.pendingProps = null;switch (b.tag) {case 1:
          ...
          z(b);V$1(X, b);V$1(ie, b);m = b.stateNode;m.pendingContext && (m.context = m.pendingContext, m.pendingContext = null);if (null === a || null === a.child) L(b), b.effectTag &= -3;N(b);return null;case 5:
          y(b);c = v();var A = b.type;if (null !== a && null != b.stateNode) {
            ...
            if (!m) return null === b.stateNode ? E$1("166") : void 0, null;a = u();if (L(b)) G(b, c, a) && d(b);else {
          ...
          if (a && null != b.stateNode) w(a, b, a.memoizedProps, m);else {
            if ("string" !== typeof m) return null === b.stateNode ? E$1("166") : void 0, null;a = v();c = u();L(b) ? I(b) && d(b) : b.stateNode = f(m, a, c, b);
          }return null;case 7:
          (m = b.memoizedProps) ? void 0 : E$1("165");b.tag = 8;A = [];a: for ((p = b.stateNode) && (p["return"] = b); null !== p;) {
...
function ff(a, b) {
  function c(a) {
    ...
    for (var b = a, c = !1, f = void 0, g = void 0;;) {
      if (!c) {
        c = b["return"];a: for (;;) {
          null === c ? E$1("160") : void 0;switch (c.tag) {case 5:
      ...
      k = a.mutation;a = a.persistence;k || (a ? E$1("235") : E$1("236"));var q = k.commitMount,
      v = k.commitUpdate,
      ...
      a: {
        for (var b = a["return"]; null !== b;) {
          ...
          E$1("161");}c.effectTag & 16 && (y(b), c.effectTag &= -17);a: b: for (c = a;;) {
        for (; null === c.sibling;) {
      ...
      switch (b.tag) {case 2:
          ...
          null === b.stateNode ? E$1("162") : void 0;c = b.memoizedProps;u(b.stateNode, null !== a ? a.memoizedProps : c, c);break;case 3:
          break;default:
          E$1("163");}
...
function kf(a) {
  function b(a) {
    Qb = ja = !0;var b = a.stateNode;b.current === a ? E$1("177") : void 0;b.isReadyForCommit = !1;id.current = null;if (1 < a.effectTag) {
      ...
      c = !1;d = void 0;try {
        for (; null !== t;) {
          var k = t.effectTag;k & 36 && Dg(t.alternate, t);k & 128 && Eg(t);if (k & 64) switch (e = t, f = void 0, null !== R && (f = R.get(e), R["delete"](e), null == f && null !== e.alternate && (e = e.alternate, f = R.get(e), R["delete"](e))), null == f ? E$1("184") : void 0, e.tag) {case 2:
              e.stateNode.componentDidCatch(f.error, { componentStack: f.componentStack });
              break;case 3:
              null === ca && (ca = f.error);break;default:
              E$1("157");}var Qc = t.nextEffect;t.nextEffect = null;t = Qc;
        }
      } catch (Tc) {
        c = !0, d = Tc;
    ...
    ja ? E$1("243") : void 0;ja = !0;a.isReadyForCommit = !1;if (a !== ra || b !== H || null === F) {
      for (; -1 < he;) ge[he] = null, he--;je = emptyObject_1;ie.current = emptyObject_1;X.current = !1;x();ra = a;H = b;F = se(ra.current, null, b);
    }var c = !1,
        d = null;try {
      f(b);
    } catch (Rc) {
      ...
      if (eb) {
        ...
        var k = h(g, d);null === k ? E$1("183") : void 0;if (!eb) {
          try {
    ...
    for (; null !== a;) {
      if (0 === a.expirationTime || a.expirationTime > b) a.expirationTime = b;null !== a.alternate && (0 === a.alternate.expirationTime || a.alternate.expirationTime > b) && (a.alternate.expirationTime = b);if (null === a["return"]) if (3 === a.tag) {
        var c = a.stateNode;!ja && c === ra && b < H && (F = ra = null, H = 0);var d = c,
            e = b;Rb > Ig && E$1("185");if (null === d.nextScheduledRoot) d.remainingExpirationTime = e, null === O ? (sa = O = d, d.nextScheduledRoot = d) : (O = O.nextScheduledRoot = d, O.nextScheduledRoot = sa);else {
    ...
    var a = 0,
      ...
      var e = d.remainingExpirationTime;if (0 === e) {
        null === c || null === O ? E$1("244") : void 0;if (d === d.nextScheduledRoot) {
    ...
    null === ma ? E$1("246") : void 0;ma.remainingExpirationTime = 0;Ub || (Ub = !0, Zc = a);
  }var r = hf(a),
      n = jf(a),
    ...
    a = od(a);return null === a ? null : a.stateNode;
      ...
      var g = b.current;if (c) {
        c = c._reactInternalFiber;var h;b: {
          2 === kd(c) && 2 === c.tag ? void 0 : E$1("170");for (h = c; 3 !== h.tag;) {
            if (le(h)) {
              h = h.stateNode.__reactInternalMemoizedMergedChildContext;break b;
            }(h = h["return"]) ? void 0 : E$1("171");
          }h = h.stateNode.context;
        }c = le(c) ? pe(c, h) : h;
      } else c = emptyObject_1;null === b.context ? b.context = c : b.pendingContext = c;b = q;b = void 0 === b ? null : b;q = null != a && null != a.type && null != a.type.prototype && !0 === a.type.prototype.unstable_isAsyncReactComponent ? d() : e(g);He(g, { expirationTime: q, partialState: { element: a }, callback: b, isReplace: !1, isForced: !1,
      ...
      var c = a.findFiberByHostInstance;return Ce(objectAssign({}, a, { findHostInstanceByFiber: function (a) {
          return b(a);
...
function Rf(a, b) {
  a = objectAssign({ children: void 0 }, b);if (b = Qf(b.children)) a.children = b;return a;
}function Sf(a, b, c, d) {
  a = a.options;if (b) {
...
function Tf(a, b) {
  ...
  null != b.dangerouslySetInnerHTML ? E$1("91") : void 0;return objectAssign({}, b, { value: void 0, defaultValue: void 0, children: "" + a._wrapperState.initialValue });
}function Vf(a, b) {
  var c = b.value;null == c && (c = b.defaultValue, b = b.children, null != b && (null != c ? E$1("92") : void 0, Array.isArray(b) && (1 >= b.length ? void 0 : E$1("93"), b = b[0]), c = "" + b), null == c && (c = ""));a._wrapperState = { initialValue: "" + c };
}
function Wf(a, b) {
...
function hg(a, b, c) {
  b && (gg[a] && (null != b.children || null != b.dangerouslySetInnerHTML ? E$1("137", a, c()) : void 0), null != b.dangerouslySetInnerHTML && (null != b.children ? E$1("60") : void 0, "object" === typeof b.dangerouslySetInnerHTML && "__html" in b.dangerouslySetInnerHTML ? void 0 : E$1("61")), null != b.style && "object" !== typeof b.style ? E$1("62", c()) : void 0);
}
function ig(a, b) {
  if (-1 === a.indexOf("-")) return "string" === typeof b.is;switch (a) {case "annotation-xml":case "color-profile":case "font-face":case "font-face-src":case "font-face-uri":case "font-face-format":case "font-face-name":case "missing-glyph":
    ...
    kg = emptyFunction_1.thatReturns("");
function lg(a, b) {
...
function pg(a, b, c, d) {
  var e = ig(b, c);switch (b) {case "iframe":case "object":
      U$1("topLoad", "load", a);var f = c;break;case "video":case "audio":
      for (f in mg) mg.hasOwnProperty(f) && U$1(f, mg[f], a);f = c;break;case "source":
      U$1("topError", "error", a);f = c;break;case "img":case "image":
      U$1("topError", "error", a);U$1("topLoad", "load", a);f = c;break;case "form":
      U$1("topReset", "reset", a);U$1("topSubmit", "submit", a);f = c;break;case "details":
      U$1("topToggle", "toggle", a);f = c;break;case "input":
      Mf(a, c);f = Lf(a, c);U$1("topInvalid", "invalid", a);
      lg(d, "onChange");break;case "option":
      f = Rf(a, c);break;case "select":
      Tf(a, c);f = objectAssign({}, c, { value: void 0 });U$1("topInvalid", "invalid", a);lg(d, "onChange");break;case "textarea":
      Vf(a, c);f = Uf(a, c);U$1("topInvalid", "invalid", a);lg(d, "onChange");break;default:
...
function sg(a, b, c, d, e) {
  var f = null;switch (b) {case "input":
      ...
      "function" !== typeof c.onClick && "function" === typeof d.onClick && (a.onclick = emptyFunction_1);}hg(b, d, kg);var g, h;a = null;for (g in c) if (!d.hasOwnProperty(g) && c.hasOwnProperty(g) && null != c[g]) if ("style" === g) for (h in b = c[g], b) b.hasOwnProperty(h) && (a || (a = {}), a[h] = "");else "dangerouslySetInnerHTML" !== g && "children" !== g && "suppressContentEditableWarning" !== g && "suppressHydrationWarning" !== g && "autoFocus" !== g && (Ra.hasOwnProperty(g) ? f || (f = []) : (f = f || []).push(g, null));for (g in d) {
...
function ug(a, b, c, d, e) {
  switch (b) {case "iframe":case "object":
      U$1("topLoad", "load", a);break;case "video":case "audio":
      for (var f in mg) mg.hasOwnProperty(f) && U$1(f, mg[f], a);break;case "source":
      U$1("topError", "error", a);break;case "img":case "image":
      U$1("topError", "error", a);U$1("topLoad", "load", a);break;case "form":
      U$1("topReset", "reset", a);U$1("topSubmit", "submit", a);break;case "details":
      U$1("topToggle", "toggle", a);break;case "input":
      Mf(a, c);U$1("topInvalid", "invalid", a);lg(e, "onChange");break;case "select":
      Tf(a, c);
      U$1("topInvalid", "invalid", a);lg(e, "onChange");break;case "textarea":
      Vf(a, c), U$1("topInvalid", "invalid", a), lg(e, "onChange");}hg(b, c, kg);d = null;for (var g in c) c.hasOwnProperty(g) && (f = c[g], "children" === g ? "string" === typeof f ? a.textContent !== f && (d = ["children", f]) : "number" === typeof f && a.textContent !== "" + f && (d = ["children", "" + f]) : Ra.hasOwnProperty(g) && null != f && lg(e, g));switch (b) {case "input":
      Bc(a);Pf(a, c);break;case "textarea":
        ...
        Of(a, c);b = c.name;if ("radio" === c.type && null != b) {
          for (c = a; c.parentNode;) c = c.parentNode;c = c.querySelectorAll("input[name\x3d" + JSON.stringify("" + b) + '][type\x3d"radio"]');for (b = 0; b < c.length; b++) {
            var d = c[b];if (d !== a && d.form === a.form) {
              var e = rb(d);e ? void 0 : E$1("90");Cc(d);Of(d, e);
            }
          }
        }break;case "textarea":
...
var Z = of({ getRootHostContext: function (a) {
    ...
    xg = td;var a = getActiveElement_1();if (Kd(a)) {
    ...
    var a = Mg,
      ...
      }b = [];for (a = c; a = a.parentNode;) 1 === a.nodeType && b.push({ element: a, left: a.scrollLeft, top: a.scrollTop });focusNode_1(c);for (c = 0; c < b.length; c++) a = b[c], a.element.scrollLeft = a.left, a.element.scrollTop = a.top;
    }Mg = null;ud(xg);xg = null;
  }, createInstance: function (a, b, c, d, e) {
    a = ng(a, b, c, d);a[Q$1] = e;a[ob] = b;return a;
    ...
    a = og(a, b);a[Q$1] = d;return a;
      ...
      a[Q$1] = f;a[ob] = c;return ug(a, b, c, e, d);
    }, hydrateTextInstance: function (a, b, c) {
      a[Q$1] = c;return vg(a, b);
...
function Pg(a, b, c, d, e) {
  Ng(c) ? void 0 : E$1("200");var f = c._reactRootContainer;if (f) Z.updateContainer(b, f, a, e);else {
  ...
  var c = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : null;Ng(b) ? void 0 : E$1("200");return pf(a, b, null, c);
}
var Sg = { createPortal: Qg, findDOMNode: function (a) {
    if (null == a) return null;if (1 === a.nodeType) return a;var b = a._reactInternalFiber;if (b) return Z.findHostInstance(b);"function" === typeof a.render ? E$1("188") : E$1("213", Object.keys(a));
  }, hydrate: function (a, b, c) {
    return Pg(null, a, b, !0, c);
  }, render: function (a, b, c) {
    return Pg(null, a, b, !1, c);
  }, unstable_renderSubtreeIntoContainer: function (a, b, c, d) {
    null == a || void 0 === a._reactInternalFiber ? E$1("38") : void 0;return Pg(a, b, c, !1, d);
  }, unmountComponentAtNode: function (a) {
    Ng(a) ? void 0 : E$1("40");return a._reactRootContainer ? (Z.unbatchedUpdates(function () {
...
Z.injectIntoDevTools({ findFiberByHostInstance: pb, bundleType: 0, version: "16.2.0", rendererPackageName: "react-dom" });var Tg = Object.freeze({ default: Sg }),
    Ug = Tg && Sg || Tg;var reactDom_production_min = Ug["default"] ? Ug["default"] : Ug;
...
var img = new Image();img.src = 'data:image/png;base64,';
...
const Gauge = props => {
  ...
  return react.createElement('div', { className: "Gauge" }, [
  /* {props.value} */
  /* <div className='circle'><img src={circle} /></div> */
  react.createElement('div', { className: "gaugeContainer" }, [react.createElement('img', { className: "circle", src: img$1 }), react.createElement('svg', { viewBox: "0 0 1 1", preserveAspectRatio: "none" }, [
  /* <circle cx={0.5} cy={0.5} r={0.35} stroke='white' stroke-width="0.03" fill="none" /> */
  react.createElement('rect', { x: 0.4, y: 0.62, width: 0.5, height: 0.2, stroke: "white", 'stroke-width': "0.02", fill: "none" }), react.createElement('text', { x: 0.25, y: 0.45,
    'font-weight': "bold",
    'font-family': "a320",
    'stroke-width': "0.1",
    'font-size': "0.13",
    fill: "white" }, ["5"]), react.createElement('text', { x: 0.58, y: 0.38,
    'font-weight': "bold",
    'font-family': "a320",
    'stroke-width': "0.1",
    'font-size': "0.13",
    fill: "white" }, ["10"]), react.createElement('text', { x: 0.72, y: 0.79,
    'font-weight': "bold",
    'text-anchor': "end",
    'font-family': "a320",
    'stroke-width': "0.1",
    'font-size': "0.15",
    fill: lightGreen }, [bigDigits]), react.createElement('text', { x: 0.78, y: 0.79,
    'font-weight': "bold",
    'font-family': "a320",
    'stroke-width': "0.1",
    'font-size': "0.13",
    fill: lightGreen }, [smallDigit]), react.createElement('circle', { cx: 0.75, cy: 0.77, r: 0.01, stroke: "white", 'stroke-width': "0", fill: lightGreen }), react.createElement('polyline', {
...
class App extends react.Component {
    render() {
        return react.createElement('div', { className: "container" }, [react.createElement('div', { className: "Panel" }, [Gauge({ value: 100.0 }), Gauge({ value: 240.75 }), Gauge({ value: 0 }), Gauge({ value: 0 }), Gauge({ value: 98 }), Gauge({ value: 10.7 }), Gauge({ value: 990 })])]);
    }
}
